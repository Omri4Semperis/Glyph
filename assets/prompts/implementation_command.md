...
- **Read the permanent rules:** Use Glyph's tool to get the `how_to_implement_a_phase_or_task.md` skill containing the authoritative guidelines for completing tasks.
