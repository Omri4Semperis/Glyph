...
2. Read an example design log using `get_example("design_log")` to understand the expected format and structure
...
5. **Evaluate step difficulty**: After each step, assess the difficulty using the following metrics:
