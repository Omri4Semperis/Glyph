...
class TestRunner:
    ...
    def display_menu(self):
        ...
        print("\n--- Archive Documents ---")
        print(" 24. Archive design log")
        print(" 25. Archive operation")
        print(" 26. Archive artifact")
        print("\n--- Unarchive Documents ---")
        print(" 27. Unarchive design log")
        print(" 28. Unarchive without description")
        print(" 29. Unarchive nonexistent document")
        print("\n--- Azure DevOps Integration ---")
        print(" 30. Parse ADO work item response (offline)")
        print(" 31. Extract display name helper (offline)")
        print(" 32. Fetch ADO work item - invalid credentials (error handling)")
        print(" 33. Query ADO work items - invalid credentials (error handling)")
        print("\n--- Input Validation ---")
